        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              ...
              Prenez soin de vous avec nos outils innovants.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/politique-de-confidentialite" className="text-gray-600 hover:text-primary text-sm">
                  Politique de confidentialité
                </Link>
              </li>
              <li>
                <Link to="/cgu" className="text-gray-600 hover:text-primary text-sm">
                  CGU
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-200 mt-8 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4 mt-4 md:mt-0">
              <Link to="/fr" className="text-gray-500 hover:text-primary text-sm">
                Français
              </Link>
              <Link to="/en" className="text-gray-500 hover:text-primary text-sm">
                English
              </Link>
            </div>
          </div>
